...
export default ({ config }: ConfigContext): ExpoConfig => ({
  ...
  extra: {
    ...(config.extra ?? {}),
    SHOPIFY_STOREFRONT_DOMAIN: process.env.EXPO_PUBLIC_SHOPIFY_STOREFRONT_DOMAIN,
    ...
    SHOPIFY_TEST_PRODUCT_HANDLE: process.env.EXPO_PUBLIC_SHOPIFY_TEST_PRODUCT_HANDLE,
